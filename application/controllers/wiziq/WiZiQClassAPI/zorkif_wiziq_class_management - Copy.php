...
class ZorkifWizIQClass {
		public $access_key="CDWxNTebtUA=";
		public $secretAcessKey="IFn+NwsdzlAhxIJrFVXM9Q==";
		public $webServiceUrl="http://class.api.wiziq.com/";
		...
		public  $WizIQ_duration ;
		public  $WizIQ_attendee_limit ;
		public  $WizIQ_presenter_default_controls ;
		public  $WizIQ_attendee_default_controls;
		public  $WizIQ_create_recording ; 
		public  $WizIQ_return_url ;
		public  $WizIQ_status_ping_url ;
		public  $WizIQ_language_culture_name ;

		
		public $WizIQ_get_recording_url; // The Url to download class recordings from
		public $WizIQ_get_class_id;
		public $WizIQ_get_presenter_url;
		public $WizIQ_get_presenter_email;
  ...
  return $theValue;
   ...
   // Now save the Create Class to the Database
	...
	public function SaveScheduledClassToDB(){		 
		...
		echo $insertSQL = sprintf("INSERT INTO eschool_courses_classes (CourseID, TeacherUserID, WizIQ_class_id, WizIQ_start_time,  WizIQ_duration, WizIQ_presenter_url, WizIQ_recording_url, CreateAt, WhoUserID) VALUES (%s, %s, %s, %s, %s, %s,  %s, %s, %s)",
...
$WizIQClass->WizIQ_start_time="2013-1-19 3:01:00";//date("Y-m-d 05:40:00"); 
