...
$query_RsCoursesList = sprintf("SELECT `eschool_courses`.*,`eschool_subjects`.* FROM `eschool_courses`,`eschool_subjects` WHERE `eschool_courses`.`SubjectID` = `eschool_subjects`.`SubjectID`  ORDER BY `eschool_courses`.CourseID DESC");
