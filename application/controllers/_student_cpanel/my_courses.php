...
WHERE 
eschool_courses.SubjectID = eschool_subjects.SubjectID  AND eschool_courses_studdent_entrollments.CourseID=eschool_courses.CourseID AND eschool_courses_studdent_entrollments.StudentUserID=%s", GetSQLValueString($colname_RsGetMyCourses, "int"));
