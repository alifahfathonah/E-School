...
$query_Rs_GetTeacherCoursesList = sprintf("SELECT eschool_courses.*, eschool_subjects.SubjectTitle FROM eschool_courses, eschool_subjects WHERE TeacherUserID = %s AND eschool_courses.SubjectID=eschool_subjects.SubjectID  AND eschool_courses.IsEnrollable=1", GetSQLValueString($colname_Rs_GetTeacherCoursesList, "int"));
