...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO user_accounts (Username, Password, FirstName, MiddleNames, LastNames, AddressLine1, AddressLine2, City, CountryID, Phone, Email, WebSite, CompanyNameIfAny, ContactNo, Others, GroupID, AccountStatus, AdditionalUsername, AdditionalPassword,CreatedAt) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
                       ...
                       GetSQLValueString($_POST['AdditionalUsername'], "text"),
                       GetSQLValueString($_POST['AdditionalPassword'], "text"),
