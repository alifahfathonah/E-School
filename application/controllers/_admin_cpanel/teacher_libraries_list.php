...
$query_RsGetTeachersLibs = sprintf("SELECT eschool_teacher_library.*,user_accounts.Username FROM eschool_teacher_library,user_accounts WHERE eschool_teacher_library.TeacherUserID=user_accounts.UserID");
