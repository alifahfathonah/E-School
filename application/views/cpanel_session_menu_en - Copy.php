...
?>                        
     ...
     <ul class="zorkif_drop_down_menu">
        <li><a href="?page_id=user_profile" class="main_menu" >Welcome!&nbsp;<?php echo $FullName; ?></a>
            <ul class="sub_menu">
        ...
        <li>
          <a href="?page_id=_admin_cpanel/teacher_libraries_list" class="main_menu">Library</a>
           <ul class="sub_menu">
            <li><a href="?page_id=_admin_cpanel/teacher_libraries_list" >Teacher Libraries</a></li>          
            <li><a href="?page_id=_admin_cpanel/teacher_library_new" >Create Library</a></li>
 		...
 		<li><a href="?page_id=_teacher_cpanel/teacher_courses" class="main_menu">Courses</a>
           <ul class="sub_menu">
            ...
            <li><a href="?page_id=_admin_cpanel/teacher_courses_studdent_attendance" >Attendance Report</a></li>
            <li><a href="?page_id=_admin_cpanel/teacher_courses_schedule_list" >Weekly Schedule</a></li>            <li><a href="?page_id=view_course_class_datesheet" >Schedule Datesheet</a></li>  
            <li><a href="?page_id=_admin_cpanel/teacher_courses_studdent_entrollments" >Enrollments</a></li>           
           </ul>
        </li>          
...
?>                        
      ...
      <ul>
        <li><a href="?page_id=user_profile" class="main_menu">Welcome!&nbsp;<?php echo $FullName; ?></a></li>
        <li>
          <a href="?page_id=_teacher_cpanel/teacher_libraries_list" class="main_menu">My Library</a>
           <ul class="sub_menu">
            <li><a href="?page_id=_teacher_cpanel/teacher_libraries_list" >Libraries</a></li>          
            <li><a href="?page_id=_teacher_cpanel/teacher_library_new" >Create Library</a></li>
            <li><a href="?page_id=_teacher_cpanel/teacher_upload_lib_meterials" >Upload Data</a></li>
           </ul>
          </li>
 		<li><a href="?page_id=_teacher_cpanel/teacher_courses" class="main_menu">Courses</a>
           <ul class="sub_menu">
            <li><a href="?page_id=_teacher_cpanel/teacher_courses_list">My Courses List</a></li>          
            <li><a href="?page_id=_teacher_cpanel/teacher_courses_new">New Courses</a></li>
            <li><a href="?page_id=_teacher_cpanel/teacher_courses_studdent_attendance" >Attendance Report</a></li>
            <li><a href="?page_id=_teacher_cpanel/teacher_courses_schedule_list" >Weekly Schedule</a></li>            <li><a href="?page_id=view_course_class_datesheet" >Schedule Datesheet</a></li>  
            <li><a href="?page_id=_teacher_cpanel/teacher_courses_studdent_entrollments" >Enrollments</a></li>           
           </ul>
        </li>          
        <li><a href="?page_id=change_password" class="main_menu">Change Password</a></li>
        <li><a href="?page_id=logout" class="main_menu">Logout</a></li>
